...
Per_Game_Page = 'https://www.basketball-reference.com/leagues/NBA_2023_per_game.html'
Advanced_Page = 'https://www.basketball-reference.com/leagues/NBA_2023_advanced.html'
Salary_Page = 'https://hoopshype.com/salaries/players/2022-2023/'
Database_name = 'nba_test.db'
...
def pipeline(url1, url2, url3, db_name):
    ...
    return pd.merge(cleaned_PerGame_Salary, cleaned_Advanced, how='left', on=['Player', 'G', 'GS', 'Age', 'Pos', 'Team', 'season'])  # type: ignore
